    ...
    return (
        <div className="h-screen mx-4 text-xs sm:text-sm md:text-base">
            ...
            <div className="grid h-full p-8 place-content-center place-items-center">
                ...
                <p className="py-4 md:w-3/5">Thank you for shopping with us.We'll send a confirmation once your order has been shipped. If you would like to check the status of your order(s) please press the link below</p>
